...
<div class="topnav" id="myTopnav">
  ...
  <a href="upds.jsp" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#D83A56'" style="color: #D83A56; font-weight: bolder; font-family: cursive; font-size: 18px;">View & Update Details
  </a>
...
<div class="font centered" onMouseOver="this.style.color='#FC92E3'" onMouseOut="this.style.color='whitesmoke'">WELCOME</div>
  ...
  <%
    ...
    String  id = (String)session.getAttribute("sd");
    Statement st = con.createStatement();
    ResultSet rs = st.executeQuery("select sname,branch from student where sid='"+id+"'");
    ...
    while(rs.next())
   {
    ...
    <div class="font below1" onMouseOver="this.style.color='#FC92E3'" onMouseOut="this.style.color='whitesmoke'"><%out.println(bran);%></div>
  <%

...
<div class="topnav" id="myTopnav">
  ...
  <a href="updt.jsp" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#D83A56'" style="color: #D83A56; font-weight: bolder; font-family: cursive; font-size: 18px;">View & Update Details
  </a>

  <a href="attendance.jsp" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#D83A56'" style="color: #D83A56; font-weight: bolder; font-family: cursive; font-size: 18px;">Post Attendance
  </a>
...
<div class="font centered" onMouseOver="this.style.color='#FC92E3'" onMouseOut="this.style.color='whitesmoke'">WELCOME</div>
  ...
  <%
    ...
    ResultSet rs = st.executeQuery("select tname,branch,sub from teacher where tid='"+id+"'");
    ...
    while(rs.next())
   {
    ...
    <div class="font below1" onMouseOver="this.style.color='#FC92E3'" onMouseOut="this.style.color='whitesmoke'"> <%out.println(bran);%> - <%out.println(subj);%></div>
  <%
